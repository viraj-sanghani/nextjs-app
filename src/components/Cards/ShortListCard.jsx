            ...
            <h4 className="c-price">
              ...
              <span>
                ...
                <span
                  ...
                  onClick={() =>
                    props?.changeShortlist && props.changeShortlist(props.data)
                  }
                >
                ...
                <span
                  className={`compare-icon ${props?.isCompare ? "active" : ""}`}
                  title={
                    props?.isCompare ? "Remove from compare" : "Add to compare"
                  }
