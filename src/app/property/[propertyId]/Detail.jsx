...
import { formatNumber, propertyBrochure } from "@/utils/helper";
        ...
        <div className="prop-left-side">
          ...
          <div className="prop-section prop-details" id="MoreDetails">
            ...
            <div className="prop-add-con">
              ...
              {detail(
                "Super Area",
                data?.super_area ? `${data?.super_area} ${data?.area_unit}` : ""
              )}
              {detail(
                "Builtup Area",
                data?.built_area ? `${data?.built_area} ${data?.area_unit}` : ""
              )}
              {detail(
                "Carpet Area",
                data?.carpet_area
              ...
              {detail("Electricity And Water Charges", data?.electricity_water)}
          ...
          {data?.int_prop_detail && (
            <div className="prop-section">
              ...
              <div className="about-prop-content">{data?.int_prop_detail}</div>
            </div>
          )}
